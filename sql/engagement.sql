...
CREATE TABLE IF NOT EXISTS `T_autodm_log` (
...
CREATE TABLE IF NOT EXISTS `T_autotweet_log` (
...
CREATE TABLE IF NOT EXISTS `T_autotweet_recurring` (
...
CREATE TABLE IF NOT EXISTS `T_autotweet_rss_feeds` (
...
CREATE TABLE IF NOT EXISTS `T_autotweet_rss_tweets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `T_autotweet_scheduled` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `T_engagement_account` (
...
CREATE TABLE IF NOT EXISTS `T_follow_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_leaders` (
  `user_id` bigint(20) unsigned NOT NULL,
  `screen_name` varchar(20) NOT NULL,
  `old_timeline_collected` datetime NOT NULL,
  `new_timeline_collected` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_tweets` (
  `tweet_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_tweet_mentions` (
  `tweet_id` bigint(20) unsigned NOT NULL,
  `created_at` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_tweet_retweets` (
  `tweet_id` bigint(20) unsigned NOT NULL,
  `created_at` datetime NOT NULL,
  `source_user_id` bigint(20) unsigned NOT NULL,
  `target_user_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_tweet_tags` (
  `tweet_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_tweet_urls` (
  `tweet_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `url` varchar(100) NOT NULL,
  `created_at` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `T_user_tags` (
  `user_id` bigint(20) unsigned NOT NULL,
  `tag` varchar(100) NOT NULL,
  KEY `user_id` (`user_id`),
  KEY `tag` (`tag`)
